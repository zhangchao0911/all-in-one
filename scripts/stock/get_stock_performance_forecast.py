#!/usr/bin/env python3
"""查询 A 股业绩预告 — 全市场指定报告期 或 单只股票全部报告期"""
import os
import sys
import urllib.parse
...
def main():
    parser = ArgParser(description="查询 A 股业绩预告")
    parser.add_argument(
    ...
    parser.add_argument("--page-size", type=int, default=20, help="每页记录数（all 默认 20，single 默认 50）")
    ...
    if args.mode == "all":
        ...
        if not args.stock_code:
            ...
            sys.exit(1)
        page_size = args.page_size if args.page_size != 20 else 50
        params = {
