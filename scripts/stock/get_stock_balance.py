#!/usr/bin/env python3
"""查询 A 股资产负债表 — 全市场指定报告期 或 单只股票全部报告期"""
import os
import sys
import urllib.parse
...
def main():
    parser = ArgParser(description="查询 A 股资产负债表")
    parser.add_argument(
    ...
    # single 模式参数
    parser.add_argument("--stock-code", default=None, help="股票代码，含市场后缀，如 603323.SH（single 模式必填）")
